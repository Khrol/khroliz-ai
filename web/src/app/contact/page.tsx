    ...
    <main style={{ maxWidth: 800, margin: "0 auto", padding: 24 }}>
      ...
      <ul style={{ listStyle: "none", padding: 0, margin: 0, display: "grid", gap: 12 }}>
        <li style={{ display: "flex", alignItems: "center", gap: 10 }}>
          ...
          <a href="http://www.linkedin.com/in/khroliz" target="_blank" rel="noreferrer" style={{ textDecoration: "underline", color: "#06c" }}>linkedin.com/in/khroliz</a>
        </li>
        <li style={{ display: "flex", alignItems: "center", gap: 10 }}>
          ...
          <a href="mailto:khroliz@gmail.com" style={{ textDecoration: "underline", color: "#06c" }}>khroliz@gmail.com</a>
        </li>
        <li style={{ display: "flex", alignItems: "center", gap: 10 }}>
          ...
          <a href="https://github.com/Khrol" target="_blank" rel="noreferrer" style={{ textDecoration: "underline", color: "#06c" }}>github.com/Khrol</a>
        </li>
      </ul>
    </main>
  );
